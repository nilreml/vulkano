...
pub fn write_descriptor_sets(doc: &parse::Spirv) -> String {
  ...
  for instruction in doc.instructions.iter() {
    ...
    let (desc_ty, readonly, array_count) = descriptor_infos(doc, pointed_ty, false).expect(&format!(
...
fn descriptor_infos(doc: &parse::Spirv, pointed_ty: u32, force_combined_image_sampled: bool) -> Option<(String, bool, u64)> {
  doc
    .instructions
    .iter()
    .filter_map(|i| {
