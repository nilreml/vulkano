...
pub fn create_vk_surface<W>(window: W, instance: Arc<Instance>) -> Result<Arc<Surface<W>>, SurfaceCreationError>
where
...
pub trait VkSurfaceBuild {
  fn build_vk_surface(self, events_loop: &EventsLoop, instance: Arc<Instance>) -> Result<Arc<Surface<winit::Window>>, CreationError>;
}
...
unsafe fn winit_to_surface<W: SafeBorrow<winit::Window>>(instance: Arc<Instance>, win: W) -> Result<Arc<Surface<W>>, SurfaceCreationError> {
