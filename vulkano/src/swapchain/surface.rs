...
impl<W> Surface<W> {
  ...
  ///
  pub unsafe fn from_raw_surface(instance: Arc<Instance>, surface: vk::SurfaceKHR, win: W) -> Surface<W> {
    Surface {
      window:        win,
      instance:      instance,
      surface:       surface,
  ...
  pub fn from_display_mode(display_mode: &DisplayMode, plane: &DisplayPlane) -> Result<Arc<Surface<()>>, SurfaceCreationError> {
    ...
    let surface = unsafe {
      ...
      check_errors(vk.CreateDisplayPlaneSurfaceKHR(instance.internal_object(), &infos, ptr::null(), &mut output))?;
      output
    };
  ...
  pub unsafe fn from_hwnd<T, U>(
    ...
    let surface = {
      ...
      let mut output = mem::uninitialized();
      check_errors(vk.CreateWin32SurfaceKHR(instance.internal_object(), &infos, ptr::null(), &mut output))?;
      output
    };
  ...
  pub unsafe fn from_xcb<C>(
    ...
    let surface = {
      ...
      let mut output = mem::uninitialized();
      check_errors(vk.CreateXcbSurfaceKHR(instance.internal_object(), &infos, ptr::null(), &mut output))?;
      output
    };
  ...
  pub unsafe fn from_xlib<D>(
    ...
    let surface = {
      ...
      let mut output = mem::uninitialized();
      check_errors(vk.CreateXlibSurfaceKHR(instance.internal_object(), &infos, ptr::null(), &mut output))?;
      output
    };
  ...
  pub unsafe fn from_wayland<D, S>(
    ...
    let surface = {
      ...
      let mut output = mem::uninitialized();
      check_errors(vk.CreateWaylandSurfaceKHR(instance.internal_object(), &infos, ptr::null(), &mut output))?;
      output
    };
  ...
  pub unsafe fn from_mir<C, S>(
    ...
    let surface = {
      ...
      let mut output = mem::uninitialized();
      check_errors(vk.CreateMirSurfaceKHR(instance.internal_object(), &infos, ptr::null(), &mut output))?;
      output
    };
  ...
  pub unsafe fn from_anativewindow<T>(instance: Arc<Instance>, window: *const T, win: W) -> Result<Arc<Surface<W>>, SurfaceCreationError> {
    let vk = instance.pointers();
    ...
    let surface = {
      ...
      let mut output = mem::uninitialized();
      check_errors(vk.CreateAndroidSurfaceKHR(instance.internal_object(), &infos, ptr::null(), &mut output))?;
      output
    };
  ...
  pub unsafe fn from_ios_moltenvk<T>(instance: Arc<Instance>, view: *const T, win: W) -> Result<Arc<Surface<W>>, SurfaceCreationError> {
    let vk = instance.pointers();
    ...
    let surface = {
      ...
      let mut output = mem::uninitialized();
      check_errors(vk.CreateIOSSurfaceMVK(instance.internal_object(), &infos, ptr::null(), &mut output))?;
      output
    };
  ...
  pub unsafe fn from_macos_moltenvk<T>(instance: Arc<Instance>, view: *const T, win: W) -> Result<Arc<Surface<W>>, SurfaceCreationError> {
    let vk = instance.pointers();
    ...
    let surface = {
      ...
      let mut output = mem::uninitialized();
      check_errors(vk.CreateMacOSSurfaceMVK(instance.internal_object(), &infos, ptr::null(), &mut output))?;
      output
    };
  ...
  /// The caller must ensure that the `window` is correct and stays alive for the entire
  /// lifetime of the surface. The `win` parameter can be used to ensure this.
  pub unsafe fn from_vi_surface<T>(instance: Arc<Instance>, window: *const T, win: W) -> Result<Arc<Surface<W>>, SurfaceCreationError> {
    let vk = instance.pointers();
    ...
    let surface = {
      ...
      let mut output = mem::uninitialized();
      check_errors(vk.CreateViSurfaceNN(instance.internal_object(), &infos, ptr::null(), &mut output))?;
      output
    };
  ...
  pub fn capabilities(&self, device: PhysicalDevice) -> Result<Capabilities, CapabilitiesError> {
    unsafe {
      ...
      let caps = {
        ...
        check_errors(vk.GetPhysicalDeviceSurfaceCapabilitiesKHR(device.internal_object(), self.surface, &mut out))?;
        out
      };

      let formats = {
        let mut num = 0;
        check_errors(vk.GetPhysicalDeviceSurfaceFormatsKHR(device.internal_object(), self.surface, &mut num, ptr::null_mut()))?;

        let mut formats = Vec::with_capacity(num as usize);
        check_errors(vk.GetPhysicalDeviceSurfaceFormatsKHR(device.internal_object(), self.surface, &mut num, formats.as_mut_ptr()))?;
      ...
      let modes = {
        let mut num = 0;
        check_errors(vk.GetPhysicalDeviceSurfacePresentModesKHR(device.internal_object(), self.surface, &mut num, ptr::null_mut()))?;

        let mut modes = Vec::with_capacity(num as usize);
        check_errors(vk.GetPhysicalDeviceSurfacePresentModesKHR(device.internal_object(), self.surface, &mut num, modes.as_mut_ptr()))?;
      ...
      Ok(Capabilities {
        ...
        max_image_count:           if caps.maxImageCount == 0 { None } else { Some(caps.maxImageCount) },
        ...
        current_transform:         capabilities::surface_transforms_from_bits(caps.currentTransform)
          .iter()
          .next()
          .unwrap(), // TODO:
