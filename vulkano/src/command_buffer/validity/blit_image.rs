...
impl error::Error for CheckBlitImageError {
  ...
  fn description(&self) -> &str {
    match *self {
      CheckBlitImageError::MissingTransferSourceUsage => "the source is missing the transfer source usage",
      CheckBlitImageError::MissingTransferDestinationUsage => "the destination is missing the transfer destination usage",
      CheckBlitImageError::SourceFormatNotSupported => "the format of the source image doesn't support blit operations",
      CheckBlitImageError::DestinationFormatNotSupported => "the format of the destination image doesn't support blit operations",
      CheckBlitImageError::DepthStencilNearestMandatory => "you must use the nearest filter when blitting depth/stencil images",
      ...
      CheckBlitImageError::UnexpectedMultisampled => "blitting between multisampled images is forbidden",
