...
pub fn check_dynamic_state_validity<Pl>(pipeline: &Pl, state: &DynamicState) -> Result<(), CheckDynamicStateValidityError>
where
...
impl error::Error for CheckDynamicStateValidityError {
  ...
  fn description(&self) -> &str {
    match *self {
      ...
      CheckDynamicStateValidityError::LineWidthMissing => "the pipeline has a dynamic line width, but no line width value was passed",
      ...
      CheckDynamicStateValidityError::ViewportsMissing => "the pipeline has dynamic viewports, but no viewports were passed",
      ...
      CheckDynamicStateValidityError::ScissorsMissing => "the pipeline has dynamic scissors, but no scissors were passed",
