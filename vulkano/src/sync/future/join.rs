  ...
  B: GpuFuture,
{
  ...
  unsafe fn build_submission(&self) -> Result<SubmitAnyBuilder, FlushError> {
    ...
    Ok(match (first, second) {
      ...
      (SubmitAnyBuilder::CommandBuffer(a), SubmitAnyBuilder::QueuePresent(b)) => unimplemented!(),
  ...
  fn check_buffer_access(
    ...
    match (first, second) {
      ...
      (Ok(_), Err(AccessCheckError::Denied(_))) | (Err(AccessCheckError::Denied(_)), Ok(_)) => panic!(
