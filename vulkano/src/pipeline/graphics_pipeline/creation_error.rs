...
impl error::Error for GraphicsPipelineCreationError {
  ...
  fn description(&self) -> &str {
    match *self {
      ...
      GraphicsPipelineCreationError::IncompatiblePipelineLayout(_) => "the pipeline layout is not compatible with what the shaders expect",
      ...
      GraphicsPipelineCreationError::WrongShaderType => "the wrong type of shader has been passed",
